...
class ProductController extends Controller
{
    ...
    public function store(ProductFormRequest $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            return redirect('/admin/products')->with('message','Product Added Successfull');
    ...
    public function update( ProductFormRequest $request, int $product_id)
    {
        ...
        if($product)
        {
            ...
            if ($request->hasFile('image')) {
                ...
                return redirect('/admin/products')->with('message','Product Updated Successfull');
    ...
    public function destroy(int $product_id)
    {
        ...
        $product->delete();
        return redirect('admin/products')->with('message','Products Deleted with all its Images');
    }
}
