            ...
            <form wire:submit.prevent="storeBrand">
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="checkbox" wire:model.defer="status"/> Checked=Hiddne, Un-Checked= VIsible
            ...
            <div wire:loading.remove>
                ...
                <form wire:submit.prevent="updateBrand">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Status</label><br>
                            <input type="checkbox" wire:model.defer="status" style="width:70px; height=70px;"/> Checked=Hiddne, Un-Checked= VIsible
                            @error('status') <small class="text-danger">{{ $message }}</small>@enderror
                        </div>
                    </div>
                    <div class="modal-footer">
